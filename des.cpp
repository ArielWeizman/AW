...
void process_message(unsigned char* message_piece, unsigned char* processed_piece, unsigned char key_sets[16][6], int nRounds)
{
	int i, k;
	int shift_size;
	...
	for (i=0; i<4; i++)
	{
		processed_piece[i] = r[i];
		processed_piece[4+i] = l[i];
	}
...
void process_message1(unsigned char* message_piece, unsigned char* processed_piece, unsigned char key_sets[16][6], int mode)
{
	int i, k;
	int shift_size;
	unsigned char shift_byte;
